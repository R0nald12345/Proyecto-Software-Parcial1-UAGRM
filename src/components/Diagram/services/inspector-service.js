...
export class InspectorService {
    ...
    // Método que crea un inspector (herramienta para inspeccionar y modificar propiedades de un elemento gráfico)
    create(cell) {

        // Desestructura los grupos e inputs desde la configuración del inspector basada en el tipo del objeto (cell)
        const { groups, inputs } = this.getInspectorConfig()[cell.get('type')];

         // Usa el método create de 'joint.ui.Inspector' para generar un inspector visual en el contenedor '.inspector-container'
        return joint.ui.Inspector.create('.inspector-container', { cell, groups, inputs });
    }

     // Método que define la configuración del inspector, como paletas de colores, estilos de fuentes, y otras opciones.
    getInspectorConfig() {

        // Paleta de colores para que el usuario elija al configurar objetos gráficos
        const options = {
            ...
            colorPaletteReset: [
             ...
             // Diferentes estilos de peso para fuentes
            fontWeight: [
            ...
            // Diferentes familias de fuentes para el texto
            fontFamily: [
             ...
             // Estilos para bordes (líneas sólidas, punteadas, etc.)
            strokeStyle: [
            ...
            // Opciones para posición de etiquetas en diferentes lados (arriba, derecha, etc.)
            side: [
            ...
            // Posiciones específicas para etiquetas en formas rectangulares
            ...
            // Posiciones específicas para etiquetas en formas elípticas
