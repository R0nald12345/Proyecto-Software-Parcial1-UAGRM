...
// const { shapes, util } = joint; // Asegúrate de importar joint.js

// const COLORS = {
//   outlineColor: '#000000', // Define tus colores
//   background: '#FFFFFF'
// };
...
// // Ejemplo de cómo crear una agregación
// function createAggregation(sourceId, targetId) {
//   return new Aggregation({
//     source: { id: sourceId, anchor: { name: "top", args: { dx: -40 } } },
//     target: { id: targetId, anchor: { name: "right", args: { dy: 30 } } },
//     labels: createLabels([
//       {
//         type: "label-target",
//         content: "seed"
...
// // Ejemplo de cómo crear una composición
// function createComposition(sourceId, targetId) {
...
class KitchenSinkService {
  ...
  initializePaper() {
    ...
    const paper = (this.paper = new joint.dia.Paper({
      ...
      defaultLink: new appShapes.app.Aggregation(),
